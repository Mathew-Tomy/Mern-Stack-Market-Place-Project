        ...
        return <div className="border-end sidenav" id="sidebar-wrapper">
            ...
            <PerfectScrollbar className="sidebar-items">
                <ul className="list-unstyled ps-0">
                    ...
                    <li className="mb-1">
                        <Link tag="a" className="" to="admin/create-category">
                            <i className="fa fa-file-o"></i> Create Category
                        </Link>
                    </li>
                    <li className="mb-1">
                        <Link tag="a" className="" to="admin/create-location">
                            <i className="fa fa-file-o"></i> Create Location
                        </Link>
                    </li>
