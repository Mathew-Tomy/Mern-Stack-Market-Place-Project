...
const socket = io('http://localhost:5000'); // Connect to the Socket.IO serve
function Messages({ match }) {
    ...
    //         // Update conversations or selected conversation based on received data
    //         // For example:
    //         if (data.chatId === chatId) {
    //             setSelected((prevSelected) => {
    //                 const updatedConversation = [...prevSelected.chats.conversation, { message: data.message, senderId: data.senderId }];
    //                 return { ...prevSelected, chats: { ...prevSelected.chats, conversation: updatedConversation } };
    //             });
    //         }
    //     });
